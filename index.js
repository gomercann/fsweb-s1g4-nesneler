...
function DegerlendirmeEkle(array1, isim, puan, geribildirim) {
  const yeniDegerlendirme = {
    isim: isim,
    puan: puan,
    geribildirim: geribildirim,
  };
  array1.push(yeniDegerlendirme);
  return array1;
}
...
function AnahtardanDegerlendirmeAl(dizi, kisiNo) {
  console.log(
    dizi[kisiNo].isim +
      " isimli kişi " +
      dizi[kisiNo].puan +
      " puan verdi ve şunları yazdı: " +
      dizi[kisiNo].geribildirim
  );
  return (
    dizi[kisiNo].isim +
    " isimli kişi " +
